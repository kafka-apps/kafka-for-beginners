...
public class MessageConsumerReplicationSyncCommitOffset {

    private static final Logger logger = LoggerFactory.getLogger(MessageConsumerReplicationSyncCommitOffset.class);
        ...
        try {
            while(true) {
                ...
                if(consumerRecords.count() > 0) {
                    kafkaConsumer.commitSync(); //commits the last record offset returned by the poll
    ...
    public static void main(String[] args) {
        MessageConsumerReplicationSyncCommitOffset messageConsumerReplication = new MessageConsumerReplicationSyncCommitOffset();
