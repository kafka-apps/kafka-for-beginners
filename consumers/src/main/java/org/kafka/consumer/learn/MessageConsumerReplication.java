...
public class MessageConsumerReplication {

    private static final Logger logger = LoggerFactory.getLogger(MessageConsumerReplication.class);
    ...
    public static void main(String[] args) {
        MessageConsumerReplication messageConsumerReplication = new MessageConsumerReplication();
