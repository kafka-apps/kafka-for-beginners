...
public class MessageConsumerReplication1 {

    private static final Logger logger = LoggerFactory.getLogger(MessageConsumerReplication1.class);
    ...
    public static void main(String[] args) {
        MessageConsumerReplication1 messageConsumerReplication = new MessageConsumerReplication1();
