...
public class MessageConsumerReplication2 {

    private static final Logger logger = LoggerFactory.getLogger(MessageConsumerReplication2.class);
    ...
    public static void main(String[] args) {
        MessageConsumerReplication2 messageConsumerReplication = new MessageConsumerReplication2();
